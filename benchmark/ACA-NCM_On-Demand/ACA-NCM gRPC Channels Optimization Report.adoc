...
image::benchmark/ACA-NCM_On-Demand/image/ping_latency.png[ping_latency, 800]

image: //insert on-demand request latency graph here

image: //insert push GS latency graph here
...
image: //insert ping speeds with different number of ports here.
