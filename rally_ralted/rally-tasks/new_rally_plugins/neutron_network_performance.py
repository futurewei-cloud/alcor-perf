...
#                    name="NeutronPerformancePlugin.neutron_network_scalability") 
@scenario.configure(context={"cleanup@openstack": ["neutron", "nova"]}, name="NeutronPerformancePlugin.neutron_network_scalability")
