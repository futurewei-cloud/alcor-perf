...
#                    name="AlcorPortPerformancePlugin.alcor_port_scalability") 
@scenario.configure(context={"cleanup@openstack": ["neutron", "nova"]}, name="AlcorPortPerformancePlugin.alcor_port_scalability")
#class AlcorPortPerformancePlugin(utils.NeutronScenario, nova_utils.NovaScenario, cinder_utils.CinderScenario):  
class AlcorPortPerformancePlugin(utils.NeutronScenario, nova_utils.NovaScenario):
